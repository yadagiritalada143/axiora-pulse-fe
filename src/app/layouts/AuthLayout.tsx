...
export function AuthLayout() {
  return (
    <div className="flex min-h-screen flex-col lg:grid lg:grid-cols-2">
      ...
      <div className="bg-background relative z-10 -mt-6 flex flex-1 flex-col rounded-t-3xl px-6 pt-8 pb-8 lg:mt-0 lg:flex-1 lg:items-center lg:justify-center lg:rounded-none lg:p-10">
